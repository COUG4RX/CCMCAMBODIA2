    ...
    <div class="container">
        <div class="page-content border">
            <div class="head-titles ccc-page-text text-center">
                <h2 class="fw-bolder">Responsibilities of the CCC Members</h2>
            </div>
              ...
              <div class="row mt-5 justify-content-center align-items-center">
                <div class="col-10 col-lg-4 col-sm-6 border member-list oversight-plan-link d-flex mx-lg-5 mx-md-5 mx-sm-3 ">
                  <div class="member-list-img my-2">
                      <img src="{{asset('assets/img/Committees/pdf.png')}}" alt="">
                  </div>
                  <div class="member-list-text my-3">
                      <h6>Oversight Plan</h6>
